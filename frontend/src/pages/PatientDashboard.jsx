...
//         const config = {
//           headers: {
//             // Your 'protect' middleware requires this Authorization header
//             Authorization: `Bearer ${storedUserInfo.token}`,
//           },
//         };

//         // This endpoint is defined in your appointmentRoutes.js
...
//         Here's your health summary. Manage your appointments and records with
//         ease.
//       </p>

//       <Row>
//         {/* These action cards are fine */}
//         <Col md={4} className="mb-4">
//           <Card className="h-100 text-center service-card">
//             <Card.Body>
//               <FaUserMd size={40} className="text-primary mb-3" />
//               <Card.Title>Find a Doctor</Card.Title>
//               <Card.Text>
//                 Search and book consultations with top specialists.
//               </Card.Text>
...
//               <Card.Title>My Health Records</Card.Title>
//               <Card.Text>
//                 Access your prescriptions and lab reports securely.
//               </Card.Text>
//               <Button variant="outline-primary">View Records</Button>
//             </Card.Body>
//           </Card>
...
//       {/* 3. DYNAMIC Upcoming Appointments List */}
