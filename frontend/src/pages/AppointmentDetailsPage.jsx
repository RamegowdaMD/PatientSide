// // frontend/src/pages/AppointmentDetailsPage.js

// import React, { useState, useEffect } from 'react';
// import { useParams, Link } from 'react-router-dom';
// import { Container, Row, Col, Card, Button, Spinner, Alert, Badge } from 'react-bootstrap';
// import axios from 'axios';
// import { FaUserMd, FaCalendarCheck, FaStethoscope, FaHourglassHalf } from 'react-icons/fa';
...
//         setError(err.response?.data?.message || 'An unexpected error occurred. Please check your connection and try again.');
//       } finally {
//         setLoading(false);
//       }
//     };
...
//   if (!appointment) {
//     // This case handles if the API returns nothing
//     return null; 
//   }

//   // =======================================================
//   // UI LOGIC FOR DIFFERENT STATUSES IS IMPLEMENTED HERE
//   // =======================================================
//   return (
//     <Container className="py-5">
//       <Link to="/dashboard" className="btn btn-light mb-4">Go Back to Dashboard</Link>
//       <Row>
//         {/* Left Column: Problem & Status */}
//         <Col md={7} lg={8}>
//           <Card className="mb-4">
//             <Card.Header as="h5"><FaStethoscope className="me-2" />Your Submitted Problem</Card.Header>
//             <Card.Body>
...
//           <Card>
//             <Card.Header as="h5"><FaCalendarCheck className="me-2" />Appointment Status</Card.Header>
//             <Card.Body>
//                 <p>
...
//                         Your request has been sent. The doctor will review it and confirm a time shortly.
//                     </Alert>
//                 )}
//                 {/* --- LOGIC FOR CONFIRMED --- */}
//                 {appointment.status === 'Confirmed' && (
//                     <div className="text-success fw-bold">
//                         <p className="mb-1">Date: {new Date(appointment.appointmentDate).toLocaleDateString()}</p>
//                         <p className="mb-0">Time: {appointment.appointmentTime}</p>
//                     </div>
//                 )}
//             </Card.Body>
//           </Card>
...
//         {/* Right Column: Doctor Info & Join Button */}
//         <Col md={5} lg={4}>
//           <Card className="text-center">
//             <Card.Header as="h5"><FaUserMd className="me-2" />Consulting Doctor</Card.Header>
//             <Card.Img 
//               variant="top" 
//               src={appointment.doctor.image || `https://i.pravatar.cc/300?u=${appointment.doctor._id}`} 
//               className="p-3"
//             />
//             <Card.Body>
...
//                       The join button will be enabled once the appointment is confirmed.
//                   </small>
//               )}
//             </Card.Body>
//           </Card>
